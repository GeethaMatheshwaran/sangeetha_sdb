...
<?php
  ...
  if(isset($_POST['submit']))
  {
    ...
    $Total = $_POST['Total'];
      $sql = "insert into sales1 (Item,Quantity,Price,Discount,Total) values ('$Item','$Quantity','$Price','$Discount','$Total')";
...
<html lang="en">
  ...
  <body>
    ...
    <DIV class ="container my-5">
        ...
        <input type="text" id="Quantity" onchange="getTotalPrice()" name="Quantity" class="form-control">
        </div>
        <div class="mb-3">
        <label>Price</label>
